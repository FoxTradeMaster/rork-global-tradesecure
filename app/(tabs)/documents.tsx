  ...
  const confirmSendDocument = async () => {
    ...
    try {
      const mappedCompanyInfo = {
        ...
        representativeContact: companyInfo.phone,
        bankName: companyInfo.bankName,
        bankAddress: companyInfo.bankName ? `${companyInfo.bankName}, ${companyInfo.country}` : companyInfo.country,
        ...
        buyerBankAddress: companyInfo.bankName ? `${companyInfo.bankName}, ${companyInfo.country}` : companyInfo.country,
        ...
        sellerName: companyInfo.companyName,
        sellerRegistration: companyInfo.registrationNumber,
        sellerAddress: companyInfo.address,
        sellerRepresentative: `${companyInfo.representative}, ${companyInfo.title}`,
        sellerSignatoryName: companyInfo.signatoryName,
        sellerSignatoryTitle: companyInfo.signatoryTitle,
        partyAName: companyInfo.companyName,
        partyARegistration: companyInfo.registrationNumber,
        partyAAddress: companyInfo.address,
        partyARepresentative: `${companyInfo.representative}, ${companyInfo.title}`,
        partyASignatoryName: companyInfo.signatoryName,
        partyASignatoryTitle: companyInfo.signatoryTitle,
        partyBName: selectedTrade.counterpartyName,
        partyBRepresentative: '[Authorized Representative]',
        buyerRepresentative: `${companyInfo.representative}, ${companyInfo.title}`,
      };
